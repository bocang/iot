...
public class RoomAddActivity extends BaseActivity {
    ...
    protected void initData() {
        isEdite = getIntent().getBooleanExtra(Constance.is_edit,false);
    ...
    public void save(View v) {
        ...
        if(isEdite){
            ApiClient.editRoom(id + "", name, new Callback<String>() {
                @Override
                ...
                public String onResponse(String response, int id) {
                    ...
                    MyToast.show(RoomAddActivity.this,getString(R.string.str_save_success));
                    finish();
                    return null;
                }
            });
